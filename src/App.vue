    ...
    <div class="container">
      ...
      <nav>
        <div class="Logo" style="display: flex; flex-direction: row;margin-top: 15px;">
          <img src="./assets/soundboardimg.png" alt="Jules" style="height: 90px; width: 175px; margin-bottom: 25px; margin-top: 25px; margin-left: 15px;">
          <p style="
      font-family: 'Inter';
      font-style: normal;
      font-weight: 200;
      ...
      color: white;"></p>
        ...
        <router-link to="/" style="margin-top: 20px;">
          ...
          <svg height="19" viewBox="0 0 32 32" width="19" fill="white" xmlns="http://www.w3.org/2000/svg"
            id="fi_2549900">
        ...
        <router-link to="/dash">
          <svg xmlns="http://www.w3.org/2000/svg" id="fi_3097412" data-name="Layer 2" width="19" height="19"
        ...
        <router-link style="margin-top: auto; margin-bottom: 50px;" to="/settings">
          <svg id="fi_2099058" enable-background="new 0 0 512 512" height="19" viewBox="0 0 512 512" width="19"
            fill="white" xmlns="http://www.w3.org/2000/svg">
            <path
...
.container {
  ...
  z-index: 0;
  /* positive so it sits above backgrounds */
}
...
/* MAIN CONTENT AREA – respects sidebar and centers children */
.main {
...
/* optional: center large page blocks inside .main */
.main>* {
  max-width: 1200px;
  /* tweak to taste */
  margin-inline: auto;
...
.myBox1 {
  ...
  display: none;
  background: #5C43F5;
  box-shadow: 5px 0 17px 6px rgba(92, 67, 245, .25);
  border-radius: 15px;
  position: absolute;
  left: 10px;
}
